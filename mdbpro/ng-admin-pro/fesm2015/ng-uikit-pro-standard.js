...
import { Subject, timer, Observable, fromEvent, from } from 'rxjs';
import { take, distinctUntilChanged, filter, map, pairwise, share, skip, throttleTime, catchError, mergeMap } from 'rxjs/operators';
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class MdbAutoCompleterComponent {
    /**
     * @param {?} renderer
     * @param {?} el
     * @param {?} platformId
    ...
    show() {
        ...
        () => {
            if (this.dropdown && !this.appendToBody) {
                ...
                /** @type {?} */
                const style$$1 = win.getComputedStyle(document$1.querySelector('.completer-dropdown'));
                /** @type {?} */
                ...
                (prev, cur) => prev + cur));
                /** @type {?} */
                const topRect = document$1.querySelector('.completer-dropdown').getBoundingClientRect().top;
                /** @type {?} */
    ...
    appendDropdown(parameters) {
        if (this._isBrowser && this.appendToBody) {
            /** @type {?} */
            const body = document$1.querySelector('body');
            /** @type {?} */
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class MdbAutoCompleterDirective {
    /**
     * @param {?} renderer
     * @param {?} el
     * @param {?} platformId
    ...
    _appendDropdownToInput() {
        ...
        /** @type {?} */
        const style$$1 = window.getComputedStyle(this.el.nativeElement);
        /** @type {?} */
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class MdbAutoCompleterOptionDirective {
    /**
     * @param {?} _el
     */
    constructor(_el) {
...
/** @type {?} */
let RemoteDataFactoryProvider = { provide: RemoteData, useFactory: remoteDataFactory, deps: [HttpClient] };
